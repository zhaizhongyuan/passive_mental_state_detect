...
if __name__ == "__main__":
    ...
    for EEG_file_number in range(1, n_EEG_file):
        ...
        dat_np_exp = dat_pd_exp.to_numpy()  # (308868, 7)
        # Pre-process an entire experiment
        Sxx_exp = exp_processing(dat_np_exp, 0)  # (252, 2100)
        print(Sxx_exp.shape)
    ...
    data_dir = "./Data"
    pickle.dump(Sxx_focused, open(os.path.join(data_dir, "focused" + ".psd"), "wb"))
    print("Focused features dumped.")
    pickle.dump(Sxx_unfocused, open(os.path.join(data_dir, "unfocused" + ".psd"), "wb"))
